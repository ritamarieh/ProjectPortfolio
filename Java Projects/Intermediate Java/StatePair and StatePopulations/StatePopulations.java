   ...
   public static void main(String[] args) throws IOException {
      ...
      for (i = 0; i < zipCodeState.size(); ++i) {
         ...
         if(zipCodeState.get(i).getValue1() == myZipCode){
            zipState = zipCodeState.get(i).getValue2();
         }
      }
      ...
      for (i = 0; i < abbrevState.size(); ++i) {
         ...
         if(abbrevState.get(i).getValue1().equals(zipState)){ //get value of first parameter in list and compare
      ...
      for (i = 0; i < statePopulation.size(); ++i) {
         ...
         if(statePopulation.get(i).getValue1().equals(stateName)){ //get value of first parameter in list and compare
